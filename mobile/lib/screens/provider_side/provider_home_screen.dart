...
class ProviderHomeContent extends StatefulWidget {
  ...
  @override
  State<ProviderHomeContent> createState() => _ProviderHomeScreenState();
}

class _ProviderHomeScreenState extends State<ProviderHomeContent> {
  Map? stats;
  List recentBookings = [];
  List reviews = [];
  bool loading = true;
                            ...
                            children: [
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text('Welcome back,', style: TextStyle(color: Colors.grey.shade500, fontSize: 13)),
                                    const SizedBox(height: 2),
                                    Text(
                                      provider?['fullName']?.toString().split(' ')[0] ?? 'Provider',
                                      style: const TextStyle(color: Color(0xFF1E293B), fontSize: 22, fontWeight: FontWeight.bold, letterSpacing: -0.5),
                                    ),
                                  ],
                                ),
                              ),
                              if (provider?['isVerified'] == true)
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      const Icon(Icons.verified_rounded, size: 12, color: Color(0xFF0891B2)),
                                      const SizedBox(width: 4),
                                      const Text('Verified', style: TextStyle(color: Color(0xFF0891B2), fontSize: 11, fontWeight: FontWeight.w600)),
                                    ],
                                  ),
                                ),
                            ],
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text('Total Earnings', style: TextStyle(color: Colors.white.withOpacity(0.7), fontSize: 13, fontWeight: FontWeight.w500)),
                                  ...
                                  Row(
                                    children: [
                                      _MiniStat(label: 'Completed', value: '${stats?['completedBookings'] ?? 0}', dark: false),
                                      const SizedBox(width: 16),
                                      _MiniStat(label: 'Pending', value: '${stats?['pendingBookings'] ?? 0}', dark: false),
                                      const SizedBox(width: 16),
                                      _MiniStat(label: 'Total', value: '${stats?['totalBookings'] ?? 0}', dark: false),
                                    ],
                                  ),
                                ],
                              ),
                    ...
                    SliverToBoxAdapter(
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            const Text('Recent Bookings', style: TextStyle(color: Color(0xFF1E293B), fontSize: 18, fontWeight: FontWeight.bold)),
                            GestureDetector(
                              onTap: () => context.pop(),
                              child: const Text('See all', style: TextStyle(color: Color(0xFF0891B2), fontSize: 13)),
                            ),
                          ],
                        ),
                      ),
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    const SizedBox(height: 12),
                                    Text('No bookings yet', style: TextStyle(color: Colors.grey.shade400)),
                                  ],
                                ),
                              ),
                            ),
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: Column(
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
                                              Text(b['user']['fullName'], style: const TextStyle(color: Color(0xFF1E293B), fontSize: 14, fontWeight: FontWeight.w600)),
                                              const SizedBox(height: 2),
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            Text('\$${b['totalPrice']}', style: const TextStyle(color: Color(0xFF0891B2), fontSize: 14, fontWeight: FontWeight.bold)),
                                          ],
                                        ),
                                      ],
                                    ),
                    ...
                    if (reviews.isNotEmpty) ...[
                      SliverToBoxAdapter(
                        child: Padding(
                          ...
                          child: const Text('Latest Reviews', style: TextStyle(color: Color(0xFF1E293B), fontSize: 18, fontWeight: FontWeight.bold)),
                        ),
                      ),
                      SliverList(
                        delegate: SliverChildBuilderDelegate(
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        Expanded(
                                          child: Text(r['user']['fullName'], style: const TextStyle(color: Color(0xFF1E293B), fontSize: 13, fontWeight: FontWeight.w600)),
                                        ),
                                        Row(
                                    ...
                                    if (r['comment'] != null) ...[
                                      ...
                                      Text(r['comment'], style: TextStyle(color: Colors.grey.shade600, fontSize: 13, height: 1.5)),
                                    ],
                                  ],
                                ),
                              ),
...
class _MiniStat extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Column(
    ...
    children: [
      ...
      Text(label, style: TextStyle(color: dark ? Colors.black.withOpacity(0.5) : Colors.white.withOpacity(0.7), fontSize: 10)),
    ],
  );
}